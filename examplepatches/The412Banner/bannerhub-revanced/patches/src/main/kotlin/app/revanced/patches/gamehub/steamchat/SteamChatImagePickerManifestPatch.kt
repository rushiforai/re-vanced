...
private const val ACTIVITY_CLASS =
    "com.xj.winemu.steamchat.BhSteamImagePickerActivity"

@Suppress("unused")
val steamChatImagePickerManifestPatch = resourcePatch(
    name = "Steam chat image-picker activity",
    description = "Registers BhSteamImagePickerActivity in the manifest so the in-game " +
        "Steam chat overlay can pick a gallery image and send it via " +
        "friends.upload_chat_image. Internal-only (android:exported=\"false\"); no " +
        "<intent-filter>.",
) {
