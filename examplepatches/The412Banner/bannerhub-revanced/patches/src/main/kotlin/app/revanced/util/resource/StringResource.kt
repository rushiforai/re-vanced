...
class StringResource(
        ...
        fun String.validateAndroidStringEscaping(): String {
            if (value.startsWith('"') && value.endsWith('"')) {
                ...
                if (value.contains('\n')) {
                    ...
                    Logger
                        .getLogger(
                            StringResource::class.java.name,
                        ).warning("String $name is not raw but contains encoded new line characters: $value")
                }
            ...
            Logger
                .getLogger(
                    StringResource::class.java.name,
                ).warning("String $name cannot contain unescaped quotes in value: $value")
    ...
    companion object {
        fun fromNode(node: Node): StringResource {
            ...
            val formatted = node.attributes
                .getNamedItem("formatted")
                ?.textContent
                ?.toBoolean() ?: true
