...
Patches are small modifications to Android apps that allow you to use Apps with MicroG on non-rooted device

## 💪 Features

Some of the features the patches provide are:

* ✅ **Support MicroG**: no need to root device
...
### ⚙️ Settings
* Allow changing patch selection ```On```
* Show universal patches ```On```
* Use alternative source ```On```
